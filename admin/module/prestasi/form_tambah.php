    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-body">
                <h3 class="box-title m-b-0">Form Tambah Prestasi</h3>
                <p class="text-muted m-b-30 font-13"> Digunakan untuk menambahkan data prestasi sekolah </p>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form action="module/prestasi/aksi_tambah.php" method="POST" enctype="multipart/form-data">                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama</label>
                                <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="Masukkan nama prestasi..." >
                            </div>
                            <div class="form-group">
