        ...
        <div class="range range-65 range-xs-center">
            <div class="cell-md-4 text-md-left">
                ...
                <div class="offset-top-30 offset-md-top-30">
                    <p>Silahkan masuk username dan password yang telah dibuat pada saat pendafataran</p>
                </div>
                <div class="offset-top-30">
                    <form class="" method="post" action="module/siswa/aksi_login.php">
                        <div class="range range-12">
                            <div class="cell-sm-12">
                                <div class="form-group"><label class="form-label form-label-outside" for="login-no-ijazah">Username</label><input class="form-control form-validation-inside" id="login-no-ijazah" type="text" name="username" data-constraints="@Required"></div>
                            </div>
                            <div class="cell-sm-12">
