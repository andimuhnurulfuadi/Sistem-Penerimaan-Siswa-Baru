            ...
            <div class="shell isotope-wrap">
                ...
                <div class="row range-30 isotope offset-top-60 text-left">
                    <div class="col-xs-12 col-sm-6 col-md-4 isotope-item">
                        <article class="post-course"><a href="prestasi-detail.php"><img class="img-responsive" src="images/slider/guru.jpg" width="370" alt=""></a>
                            <div class="post-news-body">
                                <h6><a href="prestasi-detail.php">Juara Pertama Lomba Puisi di Mars</a></h6>
                                ...
                                <a href="prestasi-detail.php" title="Selengkapnya" ><div class="post-course-meta offset-top-20"><span class="text-middle text-black">Selengkapnya</span><span class="icon inset-left-10 novi-icon icon-xs text-middle text-madison mdi-arrow-right mdi"></span></div></a>
                            </div>
                        </article>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 isotope-item">
