<?php include("header.php"); ?>
        <section class="section breadcrumb-modern context-dark parallax-container" data-parallax-img="images/backgrounds/bg-header.jpg">
            <div class="parallax-content section-30 section-sm-70">
                <div class="shell">
                    <h2 class="veil reveal-sm-block">Detail Fasilitas</h2>
                    <div class="offset-sm-top-35">
                        <ul class="list-inline list-inline-lg list-inline-dashed p">
                            <li><a href="index.php">Beranda</a></li>
                            <li><a href="fasilitas.php">Fasilitas</a></li>
                            <li>Persiapan Untuk Melawan Hulk yang Mengamuk dan Ingin Menghancurkan Bumi</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="shell">
                <div class="range range-50 range-xs-center">
                    <div class="cell-sm-8 cell-md-8 text-md-left">
                        ...
                        <div class="offset-top-30"><img class="img-responsive" src="images/slider/guru.jpg" width="770" height="500" alt="">
                    ...
                    <div class="cell-xs-8 cell-md-4 text-left">
                        <aside class="aside inset-md-left-30">
                            <div class="aside-item">
                                <h6 class="text-bold">Fasilitas Lain</h6>
                                <div class="text-subline"></div>
                                <div class="offset-top-20">
                                    <ul class="list list-marked list-marked-primary">
                                        <li><a href="#">Ruangan Komputer</a></li>
                                        <li><a href="#">Perpustakaan</a></li>
                                        <li><a href="#">Nonton Bioskop</a></li>
                                        <li><a href="#">Law</a></li>
